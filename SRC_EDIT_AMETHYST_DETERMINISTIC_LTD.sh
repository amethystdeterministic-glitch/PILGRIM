...
SLUG="amethyst-deterministic-ltd"

echo "== Amethyst v2: open Amethyst Deterministic Ltd source for editing =="
echo
...
find "$ROOT/sources" -maxdepth 3 -type d -iname "*deterministic*ltd*" 2>/dev/null | nl -ba || true
echo
